...
/** A case id like `rc-real-088` is a real Google review; `rc-syn-*` is a synthetic variant. */
...
//
// NOT fictional: these are the true numbers from the latest held-out `pnpm recovery` run (fast
// slice), staged here so the page renders the real leaderboard + the rc-real-088 contrast even when
// GET /recovery is offline or un-warmed (it returns a placeholder:true stub until the cache is
// populated). When the cache is warm the page shows the SAME numbers live (mocked:false). Refresh
// this block (and the cache) after a new run.

export const STAGED_RECOVERY: RecoveryReport = {
  dataset: { n: 8, realCount: 5, syntheticCount: 3 },
  rows: [
    { variant: "solo", grpr: 0.6, budgetTokens: 117830, budgetCalls: 65 },
    { variant: "team", grpr: 1, budgetTokens: 65197, budgetCalls: 45 },
    { variant: "team+memory", grpr: 0.8, budgetTokens: 55164, budgetCalls: 34 },
  ],
  sampleCase: {
    id: "rc-real-088",
    review: "Very average and tasteless… -1I do not recommend !",
    incidentTypeGold: "food_quality",
    solo: {
      reply:
        "Dear valued customer, we are truly sorry to hear that your recent experience with our food did not meet your expectations. Your feedback is incredibly important to us, and we strive to provide delicious meals that leave a lasting impression. We would love the chance to make it right! If you haven't tried our Tonkotsu Ramen yet, it features a rich, 18-hour broth that many of our customers rave about. As a gesture of goodwill, we would like to offer you a 20% discount on your next order. We genuinely appreciate your feedback and hope to serve you a much better meal in the future. Thank you for giving us the opportunity to improve!",
      pass: false,
      failReasons: ["politique : gesture 20% exceeds the 15% credit limit [over_promise]"],
    },
    team: {
      reply:
        "Dear valued customer, \n\nThank you for taking the time to share your feedback with us. We are genuinely sorry to hear that your experience did not meet your expectations. At Le Kyoto, we strive to provide delicious and memorable meals, and it seems we fell short this time.\n\nWe would love the opportunity to make it right for you. As a gesture of goodwill, we would like to offer you a 15% credit on your next order. We hope this will encourage you to give us another chance to impress you with our flavors.\n\nPlease reach out to us directly if you have any further concerns or suggestions. We appreciate your support and hope to serve you again soon! \n\nWarm regards, \nThe Le Kyoto Team",
      pass: true,
    },
  },
};
